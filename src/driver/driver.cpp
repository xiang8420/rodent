...
void setup_master(struct Communicator *, struct RenderSettings *);
void master_run();
void setup_worker(struct Communicator *, struct RenderSettings *, bool);
...
//    float3 eye(-3.0f, 2.0f, -7.0f), dir(0.0f, 0.0f, 1.0f), up(0.0f, 1.0f, 0.0f);
    ...
    int    rank = comm.rank;
    RenderSettings rs(eye, dir, up, fov, width, height, spp, rank, worker_size, 
            imageDecompose, get_chunk_num(), false/*ray queuing*/, 1/*thread_num*/);
